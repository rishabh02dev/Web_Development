...
// const siblingsOneLi = oneLi.parentNode.childNodes;
// console.log(siblingsOneLi);

// console.log(oneLi);
// console.log(oneLi.firstChild.nodeValue);

// oneLi.innerHTML = "<h2>changed the content of oneli</h2>";
// console.log(oneLi.firstChild);

//document.body gives document
// console.log(document.body);
//this is used to get the overall html document.
